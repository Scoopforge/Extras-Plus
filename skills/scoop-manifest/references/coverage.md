...
Sections 1-6 are the survey, 7 is the mapping, 8 the gaps, 9 the re-run recipe.
...
- **Bare-regex checkver** (~20 files) and the handful of one-off autoupdate
  shapes in section 4's last row. Left to hand-writing by design.

## 9. Refreshing the survey
